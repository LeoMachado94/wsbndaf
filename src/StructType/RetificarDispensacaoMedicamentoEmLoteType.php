...
/**
 * This class stands for RetificarDispensacaoMedicamentoEmLoteType StructType
 * @subpackage Structs
 */
class RetificarDispensacaoMedicamentoEmLoteType extends AbstractStructBase
{
    /**
     * The identificacao
    ...
    public $registro;
    /**
     * Constructor method for RetificarDispensacaoMedicamentoEmLoteType
     * @uses RetificarDispensacaoMedicamentoEmLoteType::setIdentificacao()
     * @uses RetificarDispensacaoMedicamentoEmLoteType::setRegistro()
     ...
     * @param \StructType\IdentificacaoProtocoloType $identificacao
     * @return \StructType\RetificarDispensacaoMedicamentoEmLoteType
     */
    ...
    public static function validateRegistroForArrayContraintsFromSetRegistro(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $retificarDispensacaoMedicamentoEmLoteTypeRegistroItem) {
            // validation for constraint: itemType
            if (!$retificarDispensacaoMedicamentoEmLoteTypeRegistroItem instanceof \StructType\Registro) {
                $invalidValues[] = is_object($retificarDispensacaoMedicamentoEmLoteTypeRegistroItem) ? get_class($retificarDispensacaoMedicamentoEmLoteTypeRegistroItem) : var_export($retificarDispensacaoMedicamentoEmLoteTypeRegistroItem, true);
            }
        }
