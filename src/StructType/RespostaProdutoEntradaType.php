...
/**
 * This class stands for RespostaProdutoEntradaType StructType
 * @subpackage Structs
 */
class RespostaProdutoEntradaType extends AbstractStructBase
{
    /**
     * The produto
    ...
    public $protocolo;
    /**
     * Constructor method for RespostaProdutoEntradaType
     * @uses RespostaProdutoEntradaType::setProduto()
     * @uses RespostaProdutoEntradaType::setProtocolo()
     ...
     * Set produto value
     * @param \StructType\ProdutoVinculadoSimplesType $produto
     * @return \StructType\RespostaProdutoEntradaType
     */
