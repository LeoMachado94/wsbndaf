...
/**
 * This class stands for RetificarEntradaMedicamentoEmLoteType StructType
 * @subpackage Structs
 */
class RetificarEntradaMedicamentoEmLoteType extends AbstractStructBase
{
    /**
     * The identificacao
    ...
    public $registro;
    /**
     * Constructor method for RetificarEntradaMedicamentoEmLoteType
     * @uses RetificarEntradaMedicamentoEmLoteType::setIdentificacao()
     * @uses RetificarEntradaMedicamentoEmLoteType::setRegistro()
     ...
     * @param \StructType\IdentificacaoProtocoloType $identificacao
     * @return \StructType\RetificarEntradaMedicamentoEmLoteType
     */
    ...
    public static function validateRegistroForArrayContraintsFromSetRegistro(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $retificarEntradaMedicamentoEmLoteTypeRegistroItem) {
            // validation for constraint: itemType
            if (!$retificarEntradaMedicamentoEmLoteTypeRegistroItem instanceof \StructType\Registro) {
                $invalidValues[] = is_object($retificarEntradaMedicamentoEmLoteTypeRegistroItem) ? get_class($retificarEntradaMedicamentoEmLoteTypeRegistroItem) : var_export($retificarEntradaMedicamentoEmLoteTypeRegistroItem, true);
            }
        }
