...
/**
 * This class stands for ProdutoVinculadoSaidaType StructType
 * @subpackage Structs
 */
class ProdutoVinculadoSaidaType extends ProdutoSaidaType
{
    /**
     * The coRegistro
    ...
    public $coRegistro;
    /**
     * Constructor method for ProdutoVinculadoSaidaType
     * @uses ProdutoVinculadoSaidaType::setCoRegistro()
