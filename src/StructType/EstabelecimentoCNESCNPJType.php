...
/**
 * This class stands for EstabelecimentoCNESCNPJType StructType
 * @subpackage Structs
 */
class EstabelecimentoCNESCNPJType extends AbstractStructBase
{
    /**
     * The idIdentificacao
     ...
     * @uses EstabelecimentoCNESCNPJType::setIdIdentificacao()
     * @uses EstabelecimentoCNESCNPJType::setCoCNES()
     * @uses EstabelecimentoCNESCNPJType::setNuCNPJ()
     * @param string $idIdentificacao
     * @param string $coCNES
     * @param string $nuCNPJ
     */
    public function __construct($idIdentificacao = null, $coCNES = null, $nuCNPJ = null)
    {
        $this
