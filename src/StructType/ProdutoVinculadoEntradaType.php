...
/**
 * This class stands for ProdutoVinculadoEntradaType StructType
 * @subpackage Structs
 */
class ProdutoVinculadoEntradaType extends ProdutoEntradaType
{
    /**
     * The coRegistro
    ...
    public $coRegistro;
    /**
     * Constructor method for ProdutoVinculadoEntradaType
     * @uses ProdutoVinculadoEntradaType::setCoRegistro()
