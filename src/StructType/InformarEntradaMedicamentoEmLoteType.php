...
/**
 * This class stands for InformarEntradaMedicamentoEmLoteType StructType
 * @subpackage Structs
 */
class InformarEntradaMedicamentoEmLoteType extends AbstractStructBase
{
    /**
     * The identificacao
    ...
    public $registro;
    /**
     * Constructor method for InformarEntradaMedicamentoEmLoteType
     * @uses InformarEntradaMedicamentoEmLoteType::setIdentificacao()
     * @uses InformarEntradaMedicamentoEmLoteType::setRegistro()
     ...
     * @param \StructType\IdentificacaoType $identificacao
     * @return \StructType\InformarEntradaMedicamentoEmLoteType
     */
    ...
    public static function validateRegistroForArrayContraintsFromSetRegistro(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $informarEntradaMedicamentoEmLoteTypeRegistroItem) {
            // validation for constraint: itemType
            if (!$informarEntradaMedicamentoEmLoteTypeRegistroItem instanceof \StructType\Registro) {
                $invalidValues[] = is_object($informarEntradaMedicamentoEmLoteTypeRegistroItem) ? get_class($informarEntradaMedicamentoEmLoteTypeRegistroItem) : var_export($informarEntradaMedicamentoEmLoteTypeRegistroItem, true);
            }
        }
