...
class InconsistenciaType extends AbstractStructBase
{
    ...
    /**
     * Set codigo value
     * @uses \EnumType\CodigoInconsistenciaType::valueIsValid()
     * @uses \EnumType\CodigoInconsistenciaType::getValidValues()
    ...
    public function setCodigo($codigo = null)
    {
        ...
        if (!\EnumType\CodigoInconsistenciaType::valueIsValid($codigo)) {
            throw new \InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \EnumType\CodigoInconsistenciaType', is_array($codigo) ? implode(', ', $codigo) : var_export($codigo, true), implode(', ', \EnumType\CodigoInconsistenciaType::getValidValues())), __LINE__);
        }
        $this->codigo = $codigo;
        return $this;
    }
