...
/**
 * This class stands for ProdutoVinculadoDispensacaoType StructType
 * @subpackage Structs
 */
class ProdutoVinculadoDispensacaoType extends ProdutoDispensacaoType
{
    /**
     * The coRegistro
    ...
    public $coRegistro;
    /**
     * Constructor method for ProdutoVinculadoDispensacaoType
     * @uses ProdutoVinculadoDispensacaoType::setCoRegistro()
