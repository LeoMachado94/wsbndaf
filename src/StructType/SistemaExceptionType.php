...
class SistemaExceptionType extends AbstractStructBase
{
    ...
    /**
     * Set codigo value
     * @uses \EnumType\SystemErrorCodeType::valueIsValid()
     * @uses \EnumType\SystemErrorCodeType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $codigo
     * @return \StructType\SistemaExceptionType
     */
    public function setCodigo($codigo = null)
    {
        // validation for constraint: enumeration
        if (!\EnumType\SystemErrorCodeType::valueIsValid($codigo)) {
            throw new \InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \EnumType\SystemErrorCodeType', is_array($codigo) ? implode(', ', $codigo) : var_export($codigo, true), implode(', ', \EnumType\SystemErrorCodeType::getValidValues())), __LINE__);
        }
        $this->codigo = $codigo;
        return $this;
    }
