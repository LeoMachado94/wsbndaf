...
/**
 * This class stands for InformarPosicaoEstoqueEmLoteType StructType
 * @subpackage Structs
 */
class InformarPosicaoEstoqueEmLoteType extends AbstractStructBase
{
    /**
     * The identificacao
    ...
    public $registro;
    /**
     * Constructor method for InformarPosicaoEstoqueEmLoteType
     * @uses InformarPosicaoEstoqueEmLoteType::setIdentificacao()
     * @uses InformarPosicaoEstoqueEmLoteType::setRegistro()
     ...
     * @param \StructType\IdentificacaoType $identificacao
     * @return \StructType\InformarPosicaoEstoqueEmLoteType
     */
    ...
    public static function validateRegistroForArrayContraintsFromSetRegistro(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $informarPosicaoEstoqueEmLoteTypeRegistroItem) {
            // validation for constraint: itemType
            if (!$informarPosicaoEstoqueEmLoteTypeRegistroItem instanceof \StructType\Registro) {
                $invalidValues[] = is_object($informarPosicaoEstoqueEmLoteTypeRegistroItem) ? get_class($informarPosicaoEstoqueEmLoteTypeRegistroItem) : var_export($informarPosicaoEstoqueEmLoteTypeRegistroItem, true);
            }
        }
