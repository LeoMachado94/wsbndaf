...
/**
 * This class stands for InformarSaidaMedicamentoEmLoteType StructType
 * @subpackage Structs
 */
class InformarSaidaMedicamentoEmLoteType extends AbstractStructBase
{
    /**
     * The identificacao
    ...
    public $registro;
    /**
     * Constructor method for InformarSaidaMedicamentoEmLoteType
     * @uses InformarSaidaMedicamentoEmLoteType::setIdentificacao()
     * @uses InformarSaidaMedicamentoEmLoteType::setRegistro()
     ...
     * @param \StructType\IdentificacaoType $identificacao
     * @return \StructType\InformarSaidaMedicamentoEmLoteType
     */
    ...
    public static function validateRegistroForArrayContraintsFromSetRegistro(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $informarSaidaMedicamentoEmLoteTypeRegistroItem) {
            // validation for constraint: itemType
            if (!$informarSaidaMedicamentoEmLoteTypeRegistroItem instanceof \StructType\Registro) {
                $invalidValues[] = is_object($informarSaidaMedicamentoEmLoteTypeRegistroItem) ? get_class($informarSaidaMedicamentoEmLoteTypeRegistroItem) : var_export($informarSaidaMedicamentoEmLoteTypeRegistroItem, true);
            }
        }
